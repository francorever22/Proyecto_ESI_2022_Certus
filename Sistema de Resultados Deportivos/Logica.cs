...
namespace Sistema_de_Resultados_Deportivos
{
    internal class Logica
    {
        ...
        public static List<Encuentro> GetEncuentros(int x, string constraint1, string constraint2)
        {
            List<Encuentro> encuentros = null;
            ...
            {
                case 1:
                    encuentros = db.SelectEncuentros($"SELECT * FROM Encuentros WHERE FechaEncuentro = '{constraint1}' AND EstadoEncuentro = '{constraint2}'");
                    break;
            }
            return encuentros;
        }
        ...
        public static List<Evento> GetEventos(int x, string constraint1, string constraint2)
        {
            List<Evento> eventos = null;
            ...
            {
                case 1:
                    eventos = db.SelectEventos($"SELECT * FROM Eventos WHERE FechaEvento = '{constraint1}' AND EstadoEvento = '{constraint2}'");
                    break;
            }
            return eventos;
        }
        ...
        public static List<EncuentrosFavoritos> GetEncuentrosFavoritos(int x, string constraint)
        {
            List<EncuentrosFavoritos> ef = null;

            switch (x)
            {
                case 1: //Todos
                    ef = db.SelectEncuentrosFavoritos("SELECT * FROM EncuentrosFavoritos");
                    break;
                case 2:
                    ef = db.SelectEncuentrosFavoritos($"SELECT * FROM EncuentrosFavoritos WHERE Email = '{constraint}'");
                    break;
            }
            return ef;
        }

        public static List<EventosFavoritos> GetEventosFavoritos(int x, string constraint)
        {
            List<EventosFavoritos> ef = null;

            switch (x)
            {
                case 1: //Todos
                    ef = db.SelectEventosFavoritos("SELECT * FROM EventosFavoritos");
                    break;
                case 2:
                    ef = db.SelectEventosFavoritos($"SELECT * FROM EventosFavoritos WHERE Email = '{constraint}'");
                    break;
            }
            return ef;
        }

        public static List<EquiposFavoritos> GetEquiposFavoritos(int x, string constraint)
        {
            List<EquiposFavoritos> ef = null;

            switch (x)
            {
                case 1: //Todos
                    ef = db.SelectEquiposFavoritos("SELECT * FROM EquiposFavoritos");
                    break;
                case 2:
                    ef = db.SelectEquiposFavoritos($"SELECT * FROM EquiposFavoritos WHERE Email = '{constraint}'");
                    break;
            }
            return ef;
        }
        ...
        public static void UpdateUsuario(string email, string nombre, string contrasena, string tel, int np)
        {
            db.ExecuteSql($"Update Usuarios SET NombreUsuario = '{nombre}', Contrasena = '{contrasena}', " +
                $"NumeroTelefono = '{tel}', NivelPermisos = '{np}' WHERE Email = '{email}'");
        }

        public static void UpdateUsuario(string email, string nombre)
        {
            db.ExecuteSql($"Update Usuarios SET Email = '{email}' WHERE NombreUsuario = '{nombre}'");
        }
