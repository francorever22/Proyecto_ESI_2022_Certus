...
public class DB_Connection
{
    ...
    public List<EncuentrosFavoritos> SelectEncuentrosFavoritos(string query)
    {
        List<EncuentrosFavoritos> encuentrosFavoritos = new List<EncuentrosFavoritos>();
        ...
        if (Connection_Open() == true)
        {
            ...
            while (dataReader.Read())
            {
                EncuentrosFavoritos encuentroF = new EncuentrosFavoritos();
                try
                {
                    encuentroF.email = $"{dataReader.GetString("Email")}";
                }
                catch { }
                try
                {
                    encuentroF.idEncuentro = Convert.ToInt16($"{dataReader.GetString("IdEncuentro")}");
                }
                catch { }
                try
                {
                    encuentroF.idEncuentrosFavoritos = Convert.ToInt16($"{dataReader.GetString("IdEncuentrosFavoritos")}");
                }
                catch { }

                encuentrosFavoritos.Add(encuentroF);
            }

            dataReader.Close();
            Connection_Close();

            return encuentrosFavoritos;
        }
        else
        {
            Connection_Close();
    ...
    public List<EventosFavoritos> SelectEventosFavoritos(string query)
    {
        List<EventosFavoritos> eventosFavoritos = new List<EventosFavoritos>();
        ...
        if (Connection_Open() == true)
        {
            ...
            while (dataReader.Read())
            {
                EventosFavoritos eventoF = new EventosFavoritos();
                try
                {
                    eventoF.email = $"{dataReader.GetString("Email")}";
                }
                catch { }
                try
                {
                    eventoF.idEvento = Convert.ToInt16($"{dataReader.GetString("IdEvento")}");
                }
                catch { }
                try
                {
                    eventoF.idEventosFavoritos = Convert.ToInt16($"{dataReader.GetString("IdEventosFavoritos")}");
                }
                catch { }

                eventosFavoritos.Add(eventoF);
            }
    ...
    public List<EquiposFavoritos> SelectEquiposFavoritos(string query)
    {
        List<EquiposFavoritos> equiposFavoritos = new List<EquiposFavoritos>();
        ...
        if (Connection_Open() == true)
        {
            ...
            while (dataReader.Read())
            {
                EquiposFavoritos equipoF = new EquiposFavoritos();
                try
                {
                    equipoF.email = $"{dataReader.GetString("Email")}";
                }
                catch { }
                try
                {
                    equipoF.idEquipo = Convert.ToInt16($"{dataReader.GetString("IdEquipo")}");
                }
                catch { }
                try
                {
                    equipoF.idEquiposFavoritos = Convert.ToInt16($"{dataReader.GetString("IdEquiposFavoritos")}");
                }
                catch { }

                equiposFavoritos.Add(equipoF);
            }
