...
namespace Sistema_de_Resultados_Deportivos
{
    internal class Toast
    {
        ...
        private void MatchBeginsToast(String title, String msg)
        {
            ...
            .AddText(title)
            .AddText(msg)
            .AddInlineImage(NewImage(new Bitmap(WindowsFormsApp1.Properties.Resources.barcelona), new Bitmap(WindowsFormsApp1.Properties.Resources.realmadrid), 1, null))
            .Show();
        ...
        private void EventToast(String title, String msg)
        {
            ...
            .AddText(title)
            .AddText(msg)
            .AddInlineImage(NewImage(new Bitmap(WindowsFormsApp1.Properties.Resources.barcelona), null, 4, null))
            .Show();
            ToastNotificationManagerCompat.OnActivated += toastArgs =>
            {
                ToastClick(2);
        ...
        private Uri NewImage(Bitmap image1, Bitmap image2, int type, String textImage)
        {
            ...
            {
                case 1: //For VS
                    Bitmap vs = new Bitmap(WindowsFormsApp1.Properties.Resources.versus);
