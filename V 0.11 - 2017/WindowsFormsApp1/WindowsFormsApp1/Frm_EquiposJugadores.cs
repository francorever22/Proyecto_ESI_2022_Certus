...
namespace Sistema_de_Resultados_Deportivos
{
    public partial class Frm_EquiposJugadores : Form
    {
            ...
            switch(type)
            {
                case 1: //Equipos
                    for (int j = 1; j < 11; j++)
                    {
                        ...
                        pic2.Image = WindowsFormsApp1.Properties.Resources.barcelona;
                        pic2.BackColor= Color.Transparent;
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (favorite == false)
            {
                picFavorito.BackgroundImage = WindowsFormsApp1.Properties.Resources.estrellaRellena;
                favorite = true;
            } else
            {
                picFavorito.BackgroundImage = WindowsFormsApp1.Properties.Resources.estrellaVacia;
                favorite = false;
            }
        }
        ...
        {
            /* Paneles */
            this.BackColor = AjustesDeUsuario.panel;
