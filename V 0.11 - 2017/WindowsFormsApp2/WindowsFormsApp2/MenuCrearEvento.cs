...
namespace SRD_BackOffice
{
    public partial class MenuCrearEvento : Form
    {
        ...
        private void cbxTipoFase_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (cbxTipoFase.Text)
            {
                    ...
                    for (int t = 0; t < 4; t++)
                    {
                        for (int i = 0; i < p; i++)
                        {
                            ...
                            for (int j = 0; j < 2; j++)
                            {
                                ...
                                pic1.Click += (s, EventArgs) => { DeleteTeam_Click(sender, EventArgs, controls.IndexOf(lbl1), controls.IndexOf(txtID)); };
                                ...
                                pic2.Image = WindowsFormsApp2.Properties.Resources.mas;
                                pic2.Click += (s, EventArgs) => { LookTeam_Click(sender, EventArgs, controls.IndexOf(lbl1), controls.IndexOf(txtID)); };
                ...
                case "2": //Grupos
                    ...
                    btnSizePlus.Click += (s, EventArgs) => { Plus(sender, EventArgs, 2, txtGroupSize, p3); };
                    ...
                    btnSizeMinus.Click += (s, EventArgs) => { Minus(sender, EventArgs, 2, txtGroupSize, p3); };
                    ...
                    btnAmountPlus.Click += (s, EventArgs) => { Plus(sender, EventArgs, 1, txtGroupAmount, p3); };
                    ...
                    btnAmountMinus.Click += (s, EventArgs) => { Minus(sender, EventArgs, 1, txtGroupAmount, p3); };
                ...
                case "3": //Desparejo
                    ...
                    btnAmountPPlus.Click += (s, EventArgs) => { Plus(sender, EventArgs, 1, txtPairsAmount, p4); };
                    ...
                    btnAmountPMinus.Click += (s, EventArgs) => { Minus(sender, EventArgs, 1, txtPairsAmount, p4); };
                ...
                case "4": //Posición
                    ...
                    btnSizeTPlus.Click += (s, EventArgs) => { Plus(sender, EventArgs, 2, txtTableSize, p5); };
                    ...
                    btnSizeTMinus.Click += (s, EventArgs) => { Minus(sender, EventArgs, 2, txtTableSize, p5); };
                ...
                case "5": //Eliminatorias
                    ...
                    btnSizeEPlus.Click += (s, EventArgs) => { Plus(sender, EventArgs, 2, txtTableESize, p6); };
                    ...
                    btnSizeEMinus.Click += (s, EventArgs) => { Minus(sender, EventArgs, 2, txtTableESize, p6); };
        ...
        private void LookTeam_Click(object sender, EventArgs e, int lblI, int txtId)
        {
            ...
            btnBuscar.Image = WindowsFormsApp2.Properties.Resources.lupa;
            ...
            btn1.Text = "Add";
            btn1.Click += (s, EventArgs) => { AddTeam(sender, EventArgs, eqName, eqId); };

            btnBuscar.Click += (s, EventArgs) => { BuscarEquipo(sender, EventArgs, buscador.Text, panelContenedor); };
            ...
            foreach (var eq in equipos)
            {
                ...
                btn2.Click += (s, EventArgs) => { BtnChange(sender, EventArgs, btn2, panelContenedor, eq.NombreEquipo, eq.IdEquipo); };
        ...
        private void BuscarEquipo(object sender, EventArgs e, string busqueda, Panel p)
        {
            ...
            foreach (var eq in equipos)
            {
                if (busqueda == Convert.ToString(eq.IdEquipo) || eq.NombreEquipo.Contains(busqueda) || eq.PaisOrigen.Contains(busqueda))
                {
                    ...
                    btn1.BackgroundImage = WindowsFormsApp2.Properties.Resources.mas;
                    btn1.Click += (s, EventArgs) => { AddTeam(sender, EventArgs, eq.NombreEquipo, eq.IdEquipo); };
