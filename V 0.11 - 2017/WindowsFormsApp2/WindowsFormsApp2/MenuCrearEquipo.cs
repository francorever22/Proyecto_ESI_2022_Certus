...
namespace SRD_BackOffice
{
    public partial class MenuCrearEquipo : Form
    {
        ...
        private void picAddPlayer_Click(object sender, EventArgs e)
        {
            ...
            btn1.Text = "Add";
            btn1.Click += (s, EventArgs) => { AddMember(sender, EventArgs); };

            btnBuscar.Click += (s, EventArgs) => { BuscarDeportista(sender, EventArgs, buscador.Text, panelContenedor); };
            ...
            foreach (var d in deportistas)
            {
                ...
                btn2.Click += (s, EventArgs) => { BtnChange(sender, EventArgs, btn2, panelContenedor, d.IdPersona, d.Nombre+" "+d.Apellido); };
        ...
        private void BuscarDeportista(object sender, EventArgs e, string busqueda, Panel p)
        {
            ...
            foreach (var d in deportistas)
            {
                if (busqueda == Convert.ToString(d.IdPersona) || (d.Nombre+" "+d.Apellido).Contains(busqueda) || d.Nacionalidad.Contains(busqueda))
                {
                    ...
                    btn1.Click += (s, EventArgs) => { BtnChange(sender, EventArgs, btn1, p, d.IdPersona, d.Nombre + " " + d.Apellido); };
        ...
        private void AddMember(object sender, EventArgs e)
        {
            ...
            pic1.SizeMode = PictureBoxSizeMode.StretchImage;
            pic1.Image = WindowsFormsApp2.Properties.Resources.cruz;
            pic1.Click += (s, EventArgs) => { KickMember(sender, EventArgs, miembros.IndexOf(idMember), p1); };
