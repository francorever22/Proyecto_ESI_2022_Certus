        ...
        private void btnBuscar_Click(object sender, EventArgs e, string busqueda)
        {
            ...
            foreach (var deporte in deportes)
            {
                if (deporte.nombreDeporte.Contains(busqueda) || deporte.categoriaDeporte.Contains(busqueda))
                {
                    ...
                    pic1.SizeMode = PictureBoxSizeMode.StretchImage;
                    pic1.Image = WindowsFormsApp2.Properties.Resources.cruz;
                    pic1.Click += (s, EventArgs) => { DeleteSport_Click(sender, EventArgs, deportes, deporte, p1); };
                    ...
                    pic2.SizeMode = PictureBoxSizeMode.StretchImage;
                    pic2.Image = WindowsFormsApp2.Properties.Resources.pluma;
                    pic2.Click += (s, EventArgs) => { ModifySport_Click(sender, EventArgs, deportes.IndexOf(deporte)); };
            ...
            foreach (var categoria in categorias)
            {
                if (categoria.nombreCategoria.Contains(busqueda))
                {
                    ...
                    pic3.Image = WindowsFormsApp2.Properties.Resources.cruz;
                    pic3.Click += (s, EventArgs) => { DeleteCategory_Click(sender, EventArgs, categorias, categoria, p2); };
                    ...
                    pic4.Image = WindowsFormsApp2.Properties.Resources.pluma;
                    pic4.Click += (s, EventArgs) => { ModifyCategory_Click(sender, EventArgs, categorias.IndexOf(categoria)); };
