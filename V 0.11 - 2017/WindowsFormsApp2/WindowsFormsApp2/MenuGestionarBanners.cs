        ...
        private void btnBuscar_Click(object sender, EventArgs e, string busqueda)
        {
            ...
            foreach (var banner in banners)
            {
                if (busqueda == Convert.ToString(banner.IdBanner) || banner.TitleBanner.Contains(busqueda) || banner.Link.Contains(busqueda))
                {
                    ...
                    pic1.SizeMode = PictureBoxSizeMode.StretchImage;
                    pic1.Image = WindowsFormsApp2.Properties.Resources.cruz;
                    pic1.Click += (s, EventArgs) => { Delete_Click(sender, EventArgs, banners, banner, p1); };
                    ...
                    pic2.SizeMode = PictureBoxSizeMode.StretchImage;
                    pic2.Image = WindowsFormsApp2.Properties.Resources.pluma;
                    pic2.Click += (s, EventArgs) => { ModifyBanner_Click(sender, EventArgs, banners.IndexOf(banner)); };
